...
export class DashboardComponent implements AfterViewInit {
  ...
  createWidget<componentType extends DashboardBaseDirective>(component: Type<componentType>, form: NgForm){
    ...
    const componentRef: ComponentRef<componentType> = this.container.createComponent(component);
